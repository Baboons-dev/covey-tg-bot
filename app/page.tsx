...
const navigationCards = [
  {
    ...
    title: "Telegram Apps",
    description:
      "Explore our collection of powerful Telegram bots and applications",
    href: "/apps",
  },
  {
    icon: Code2Icon,
          ...
          <section className="pt-24 pb-8">
            <div className="flex flex-col items-start space-y-2">
              ...
              <p className="text-base sm:text-lg text-white/80 mt-2 leading-relaxed max-w-2xl">
                Welcome to Covey's portfolio of innovative solutions. Explore
                our services and discover how we can help you succeed.
              </p>
            </div>
          </section>
